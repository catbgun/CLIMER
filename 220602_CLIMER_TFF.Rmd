...
ggscatter(dx, x = "sUVa", y = "THg_DOC" , 
          add = "reg.line", conf.int = TRUE, 
          cor.coef = TRUE, cor.method = "pearson",
          xlab ="sUva" , ylab ="Hg:DOC")+
  facet_grid(.~Position)
```
...
#Relative biodeg
rel_biodeg <- ggplot(b3, aes(x=Fraction, y= Rel.rate.DOC))+
  ...
  theme(axis.text.y = element_text(size= 14, colour="black"),
        ...
        axis.text.x = element_text(angle=0, hjust=0.5, vjust=0, size = 16, colour="black"),
        plot.title=element_text(size=30, face="bold"),
